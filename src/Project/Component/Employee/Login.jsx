...
class EmployeeLogin extends OwnCustomForm {
  constructor(props) {
    super(props);
    this.state = {
      data: {
  ...
  doSubmit = async (e) => {
    ...
    urlencoded.append(
      "client_secret",
      "bbnhoCXjmcHIDizIaHuwJBjm0pcJPzF4MIBNYtZi"
    );
    urlencoded.append("grant_type", "password");
    let data = await login(urlencoded);
    let setToken = EmployeeLoginCredentialContext.SetToken({ token: data });
    if (setToken) {
      localStorage.setItem("accessTokenEmployee", data);
        ...
        <Container fluid>
          <Row className="mt-5">
            ...
            <Col md="4">
              <Card>
                <Card.Header>
                  <Card.Title as="h4">Employee Login</Card.Title>
                </Card.Header>
                <Card.Body>
